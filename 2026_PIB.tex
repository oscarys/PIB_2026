...
\date{\today}
 \logo{\includegraphics[height=0.8cm]{shared/lini_logo_original_small}} 

\begin{document}
	
	\input{slides/00_title}
	\input{slides/01_outline}
	\section{Motivación y Contexto}
	\subsection{qEEG}
	\input{slides/002_eeg_scroll}
	\input{slides/02_motivation}
	\subsection{EEG 101}
	\input{slides/03_eeg_primer}
	\input{slides/03a_eeg_primer}
	\input{slides/04_history}
	\input{slides/04a_history}
	\input{slides/05_preprocessing}
	\input{slides/05a_preprocessing}
	\section{Análisis del EEG}
	\subsection{Espectral}
	\input{slides/06_spectral}
	\input{slides/06a_spectral}
    \input{slides/06b_spectral}
    \input{slides/06c_spectral}
    \input{slides/06d_spectral}
	\subsection{Conectividad funcional}
	\input{slides/07_connectivity}
	\input{slides/07a_conectivity}
	\input{slides/07b_conectivity}
	\input{slides/07c_conectivity}
	\subsection{Interfaz cerebro computadora}
	\input{slides/09a_ml}
	\input{slides/09b_ml}
	\section{Aplicaciones clínicas}
	\input{slides/11_clinical_epilepsy_sleep}
	\input{slides/12_clinical_psychiatry}
	\section{Limitaciones y perspectivas}
	\input{slides/13_limitations}
	\input{slides/14_conclusions}
	\input{slides/15_references}
	\input{slides/16_goodbye}
